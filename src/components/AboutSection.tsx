        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
          ...
          <div className="w-full lg:w-5/12 sticky top-24">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-white/5 border border-white/10 rounded-2xl p-4 flex flex-col items-center justify-center text-center hover:border-emerald-500/40 transition-colors group"
                >
          ...
          <div className="w-full lg:w-7/12 pt-4">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-8 leading-tight">
              Driven by <span className="text-emerald-500">Innovation</span> &{" "}
              <br />
              Technical Precision
            </h2>
            ...
            <div className="space-y-6 text-slate-400 text-lg leading-relaxed mb-10">
              <p>
                ...
                with over half a decade of experience in crafting digital
                solutions that merge creativity with deep technical logic. Based
                in Bangladesh, I have helped numerous brands build scalable
                platforms from the ground up.
              </p>
              <p>
                My expertise lies in building high-performance applications
                using the{" "}
                <span className="text-emerald-400">MERN & Next.js stack</span>.
                I don,t just write code; I architect experiences that are
                blazing fast, accessible, and future-proof. Whether it,s complex
                backend engineering or pixel-perfect interactive frontends, I
                ensure every project meets the highest industry standards.
              </p>
              <p>
                Currently, I am focused on pushing the boundaries of web
                technology, exploring real-time systems, and contributing to
                open-source communities while delivering premium value to my
                clients worldwide.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-6 border-t border-white/10">
              {highlights.slice(0, 2).map((item, idx) => (
                <div key={idx} className="flex gap-4 items-start group">
                  <div className="shrink-0 w-10 h-10 rounded-xl bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20 group-hover:border-emerald-500/50 transition-all">
