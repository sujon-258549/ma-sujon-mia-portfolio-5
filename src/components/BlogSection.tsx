    ...
    >
      ...
      <div className="main-container relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-16">
          <Link
            href="/blog"
            className="group relative inline-flex items-center gap-4 px-10 py-4 bg-white/5 text-white font-black text-[11px] uppercase tracking-[0.3em] overflow-hidden rounded-lg transition-all hover:bg-white/10 border border-white/10 shadow-2xl"
          >
            ...
            <div className="flex gap-4">
              {hasMore && (
                <button
                  ...
                  className="group relative inline-flex items-center gap-4 px-8 py-4 bg-emerald-500 text-black font-black text-[11px] uppercase tracking-[0.2em] overflow-hidden rounded-lg transition-all hover:bg-emerald-400 shadow-2xl shadow-emerald-500/20 cursor-pointer active:scale-95"
                >
                  <span>Load More</span>
              ...
              {visibleCount > 3 && (
                <button
                  ...
                  className="group relative inline-flex items-center gap-4 px-8 py-4 bg-[#1A2426] text-slate-400 font-black text-[11px] uppercase tracking-[0.2em] overflow-hidden rounded-lg transition-all hover:text-white border border-white/10 cursor-pointer active:scale-95"
                >
                  <span>Collapse</span>
